...
// Color palette
const C_BG2:     u32 = 0x00000000;  // transparent corners (compositor shows wallpaper through)
...
fn draw(sw: u32, sh: u32, hover_idx: Option<usize>) {
    // Clear surface to transparent so compositor wallpaper shows through.
...
fn main() {
    ...
    // Tell compositor this surface has transparency (wallpaper shows through).
