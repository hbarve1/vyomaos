...
mod desktop;
pub(crate) use desktop::chrome;
pub(crate) use desktop::wallpaper;
pub(crate) use desktop::theme;
pub(crate) use desktop::tray;
pub(crate) use desktop::toast;
pub(crate) use desktop::menus;
pub(crate) use desktop::win_actions;
pub(crate) use desktop::workspace;
pub(crate) use desktop::session;
pub(crate) use desktop::accessibility;
pub(crate) use desktop::i18n;
pub(crate) use desktop::screenshot;
pub(crate) use desktop::resize;
...
pub(crate) use hardware::cpu;
pub(crate) use hardware::memory;
pub(crate) use hardware::uefi;
mod draw_cmd;
mod input_keys;
mod ipc_commands;
mod ipc_handlers;
...
pub(crate) use security::user;
pub(crate) use security::user_caps;
...
fn main() {
    ...
    #[cfg(target_os = "linux")]
    {
        ...
        thread::Builder::new()
            ...
            .spawn(move || {
                let mut last = display::screen_size().unwrap_or((DEFAULT_SCREEN_W, DEFAULT_SCREEN_H));
                loop {
